    ...
    <form action="{{ route('bom.store') }}" method="POST">
      ...
      <table class="table">
        ...
        <tbody id="bom-components">
          <tr>
            <td>
              <select name="components[0][material_id]" class="form-control" required>
            ...
            <td>
              <input type="number" name="components[0][quantity]" class="form-control" placeholder="Quantity" step="0.01" required>
            </td>
          </tr>
        </tbody>
      </table>
