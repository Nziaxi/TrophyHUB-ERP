  ...
  <div class="sidebar" style="background-color: #a8b8de;">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="/home" class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }} font-weight-medium" style="color: #000;">
            <p>
              Dashboard
            </p>
          </a>
        ...
        <li class="nav-item">
          <a href="{{ url('/products') }}" class="nav-link {{ Route::currentRouteName() == 'products' ? 'active' : '' }} font-weight-medium"
            style="color: #000;">
            <p>Produk</p>
          </a>
        </li>
