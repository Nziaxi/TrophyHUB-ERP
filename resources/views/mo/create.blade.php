    ...
    document.getElementById('load-materials-btn').addEventListener('click', function() {
      ...
      if (bomId) {
        ...
        if (selectedBom && selectedBom.components.length > 0) {
          selectedBom.components.forEach((component, index) => {
            const row = `
                        <tr>
                            ...
                            <td><input type="number" name="materials[${index}][required]" class="form-control" value="${component.quantity}" readonly></td>
                            <td><input type="number" name="materials[${index}][ordered]" class="form-control" value="0" required></td>
                            <td><input type="number" name="materials[${index}][used]" class="form-control" value="0" required></td>
          ...
          materialTableBody.innerHTML = `<tr><td colspan="4" class="text-center">Tidak ada bahan untuk Kode BoM ini.</td></tr>`;
        }
      } else {
